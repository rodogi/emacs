...
(use-package evil
  ...
  (evil-mode 1))
#+end_src
Accents, accents everywhere (I am a Spanish speaker)
#+BEGIN_SRC emacs-lisp
(defun read-accent (letter)
  "Return acute accented vowel"
  (interactive "c")
  (setq letter (char-to-string letter))
  (cond ((string= letter "a") (insert-char 0225))
        ((string= letter "A") (insert-char 0193))
        ((string= letter "e") (insert-char 0233))
        ((string= letter "E") (insert-char 0201))
        ((string= letter "i") (insert-char 0237))
        ((string= letter "I") (insert-char 0205))
        ((string= letter "o") (insert-char 0243))
        ((string= letter "O") (insert-char 0211))
        ((string= letter "u") (insert-char 0250))
        ((string= letter "U") (insert-char 0218))
        (t (insert-char 593))))
(defun tilde-n (letter)
  "Return the letter n with a tilde"
  (interactive "c")
  (setq letter (char-to-string letter))
  (cond ((string= letter "n") (insert-char 241))
        (t (insert-char 241))))
(global-set-key (kbd "M-e") 'read-accent)
(global-set-key (kbd "M-n") 'tilde-n)
#+END_SRC
...
Sometimes I need the interactive python shell in python. It is most useful when it seems
I am working in =ipython= inside a terminal.
#+BEGIN_SRC emacs-lisp
(defun ipython-arrows ()
  "Set arrows as in ipython"
  (local-set-key (kbd "<up>") 'comint-previous-input)
  (local-set-key (kbd "<down>") 'comint-next-input))
(defun ipython-beginning-and-end ()
  "Set EOL and BOL to C-a and C-e, respectively"
  (local-set-key (kbd "C-a") 'beginning-of-line)
  (local-set-key (kbd "C-e") 'end-of-line))
(add-hook 'inferior-python-mode-hook 'ipython-beginning-and-end)
(add-hook 'inferior-python-mode-hook 'ipython-arrows)
#+END_SRC
...
#+end_src
Let's bind `C-x C-a` to =helm-apropos=
#+BEGIN_SRC emacs-lisp
...
#+end_src
* Tramp
  Sometimes, I like working in a remote server. I use mainly python so I want to work when I am
